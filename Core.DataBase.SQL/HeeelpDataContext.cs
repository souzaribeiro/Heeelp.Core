namespace Heeelp.Core.DataBase.SQL
{
    using System;
    ...
    public partial class HeeelpDataContext : DbContext
    {
        public HeeelpDataContext(string nameOrConnectionString)
        ...
        public virtual DbSet<FIleTemp> FIleTemp { get; set; }
        ...
        public virtual DbSet<PersonBenefitClub> PersonBenefitClub { get; set; }        
        public virtual DbSet<PersonType> PersonType { get; set; }
        //public virtual DbSet<RulesStatus> RulesStatus { get; set; }
        ...
        public virtual DbSet<BaseCEPs> BaseCEPs { get; set; }

        public virtual DbSet<SelfRegistration> SelfRegistration { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //    modelBuilder.Entity<Person>()
            //        .Property(e => e.CustomHeeelpPersonDomain)
            //        .IsUnicode(false);

            //    modelBuilder.Entity<Person>()
            //        .Property(e => e.CustomClubName)
            //        .IsUnicode(false);
            ...
            //    //modelBuilder.Entity<PersonProfile>()
            //    //    .HasMany(e => e.PersonRules)
            //    //    .WithRequired(e => e.PersonProfile)
            //    //    .WillCascadeOnDelete(false);
            ...
            //    modelBuilder.Entity<RulesStatus>()
            //        .Property(e => e.Name)
            //        .IsUnicode(false);

            //    //modelBuilder.Entity<RulesStatus>()
            //    //    .HasMany(e => e.PersonRules)
            //    //    .WithRequired(e => e.RulesStatus)
            //    //    .WillCascadeOnDelete(false);
            ...
            //    modelBuilder.Entity<BaseCEPs>()
            //        .Property(e => e.ibge_cod_uf)
            //        .IsFixedLength()
            //        .IsUnicode(false);

            //    modelBuilder.Entity<BaseCEPs>()
            //        .Property(e => e.ibge_cod_cidade)
            //        .IsFixedLength()
            //        .IsUnicode(false);

            //    modelBuilder.Entity<BaseCEPs>()
            //        .Property(e => e.area_cidade_km2)
            //        .IsFixedLength()
            //        .IsUnicode(false);

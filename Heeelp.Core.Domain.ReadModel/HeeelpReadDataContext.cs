namespace Heeelp.Core.Domain.ReadModel
{
    ...
    public partial class HeeelpReadDataContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<Person>()
            //    .HasMany(e => e.PersonBenefitClub1)
            //    .WithRequired(e => e.Person)
            ...
            modelBuilder.Entity<PersonBenefitClub>()
            ...
            modelBuilder.Entity<PersonBenefitClub>()
                .Property(e => e.CustomClubLogo)
                .IsUnicode(false);

            //modelBuilder.Entity<PersonBenefitClub>()
            //    .HasMany(e => e.Person)
            //    .WithOptional(e => e.PersonBenefitClub)
            //    .HasForeignKey(e => e.PersonBenefitClubId);

...
{
    [Validator(typeof(PersonAddressProspectDTO))]
    public class PersonAddressProspectDTO
    {
    ...
    public class PersonAddressProspectDTOValidator : AbstractValidator<PersonAddressProspectDTO>
    {
        public PersonAddressProspectDTOValidator()
        {

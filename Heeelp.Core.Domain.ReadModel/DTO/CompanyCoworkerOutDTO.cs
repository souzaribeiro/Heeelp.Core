...
{
    [Validator(typeof(CompanyCoworkerOutDTO))]
    public class CompanyCoworkerOutDTO
    {
    ...
    public class CompanyCoworkerOutDTOValidator : AbstractValidator<CompanyCoworkerOutDTO>
    {
        public CompanyCoworkerOutDTOValidator()
        {

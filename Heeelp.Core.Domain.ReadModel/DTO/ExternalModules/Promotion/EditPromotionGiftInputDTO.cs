...
{
    [Validator(typeof(EditPromotionGiftInputDTO))]
    public class EditPromotionGiftInputDTO
    {
    ...
    public class EditPromotionGiftInputDTOValidator : AbstractValidator<EditPromotionGiftInputDTO>
    {
        public EditPromotionGiftInputDTOValidator()
        {

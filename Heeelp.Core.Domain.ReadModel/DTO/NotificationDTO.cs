...
namespace Heeelp.Core.Domain.ReadModel.DTO
{
    public class NotificationDTO
    {
        ...
        public NotificationDTO(int personFromId, int personToId, string personName, int languageId, string messageCodeType, string title, string customClub, string customHeeelpPersonDomain, string logotipo)
        {

...
{
    [Validator(typeof(NewCoworkingDTO))]
    public class NewCoworkingDTO
    {
    ...
    public class NewCoworkingDTOValidator : AbstractValidator<NewCoworkingDTO>
    {
        public NewCoworkingDTOValidator()
        {
